...
class ConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetConfig()
    {
        ...
        $result = Shopware()->Db()->fetchRow($sql, [$configName]);
    ...
    public function testGetGeneralConfig()
    {
        ...
        $result = Shopware()->Db()->fetchPairs($sql, ['general']);
    ...
    public function testSetGeneralConfigsArrays()
    {
        ...
        $result = Shopware()->Db()->fetchPairs($sql, ['general', $configName]);
    ...
    public function testGetImportConfig()
    {
        ...
        $sql = 'SELECT name, value FROM s_plugin_connect_config WHERE shopId IS NULL AND groupName = ?';
        $result = Shopware()->Db()->fetchPairs($sql, ['import']);
    ...
    public function testSetImportConfigs()
    {
        ...
        $configValue = $connection->fetchColumn('
          SELECT `value` 
    ...
    public function testSetImportConfigsActivatesImageCronJob()
    {
        ...
        $cronActive = $connection->fetchColumn("
          SELECT active
          FROM s_crontab
    ...
    {
        $this->getConfigComponent()->setConfig('testConfigArray', [0, 1, 'value']);
        $exportConfig = $this->getConfigComponent()->getExportConfig();

        $sql = 'SELECT name, value FROM s_plugin_connect_config WHERE shopId IS NULL AND groupName = ?';
        $result = Shopware()->Db()->fetchPairs($sql, ['export']);
    ...
    public function testSetExportConfigs()
    {
        ...
        $sql = 'SELECT name, value FROM s_plugin_connect_config WHERE shopId IS NULL AND groupName = ? AND name = ?';
        $result = Shopware()->Db()->fetchPairs($sql, ['export', $configName]);
    ...
    public function testCompareExportConfiguration()
    {
        ...
        $exportConfig = Shopware()->Db()->fetchPairs($sql, ['export']);
    ...
    {
        $marketplaceSettings = new MarketplaceSettings([
        ...
        $result = Shopware()->Db()->fetchAll($sql, ['marketplace']);
    ...
    public function testGetUnitsMappings()
    {
        ...
        $sql = 'SELECT name, value FROM s_plugin_connect_config WHERE shopId IS NULL AND groupName = ?';
        $result = Shopware()->Db()->fetchPairs($sql, ['units']);
