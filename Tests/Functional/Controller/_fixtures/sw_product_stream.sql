INSERT INTO s_product_streams (name, conditions, type, sorting, description, sorting_id) VALUES ('AwStream', null, 2, '"{\\"Shopware\\\\\\\\Bundle\\\\\\\\SearchBundle\\\\\\\\Sorting\\\\\\\\PriceSorting\\":{\\"direction\\":\\"DESC\\"}}"', 'lorem ipsum', 4);
