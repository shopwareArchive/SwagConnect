...
Ext.define('Shopware.apps.Connect.view.config.import.Form', {
    ...
    snippets: {
        ...
        overwritePropertiesHelptext: '{s name=config/import/overwrite_properties_helptext_v2}Gebe an, welche Felder überschrieben werden sollen, wenn dein Lieferant sie ändert. Diese Einstellung kannst du auch pro Artikel treffen. Gehe dafür direkt in den Artikel und dann auf den Tab Shopware Connect.{/s}'
    },
