 ...
 *
 * The whole conversion system is needed, as we do not want to have
 * dependencies inside the SDK on any internal Shopware Connect data structure.
 * Therefore the Shopware Connect side has to convert the data during
