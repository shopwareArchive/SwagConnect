...
class AutoCategoryResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResolve()
    {
        ...
        if (!$bootsCategory) {
            $this->categoryResolver->createLocalCategory('Boots', '/deutsch/boots', $defaultCategory->getId(), 1234, 'test Stream');
        }
        ...
        if (!$nikeCategoryId) {
            $nikeCategoryId = $this->categoryResolver->createLocalCategory('Nike', '/deutsch/nike', $defaultCategory->getId(), 1234, 'test Stream');
        }
        ...
        if (!$nikeBootsCategory) {
            $this->categoryResolver->createLocalCategory('Boots', '/deutsch/nike/boots', $nikeCategoryId, 1234, 'test Stream');
        }
        ...
        $categoryModels = $this->categoryResolver->resolve($categories, 1234, 'test Stream');
